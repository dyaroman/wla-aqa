...
<template>
  <TestsResultsList type="fail" :testsResults="failed" :build-number />
  <TestsResultsList type="pass" :testsResults="passed" />
  <TestsResultsList type="skip" :testsResults="skipped" />
</template>
